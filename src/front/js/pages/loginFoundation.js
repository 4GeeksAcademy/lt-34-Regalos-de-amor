...
export const LoginFoundation = () => {
	...
	return (
		<div><section className="vh-xxl-100">
						...
						<div className="row g-0">
							...
							<div className="col-lg-6 order-1">
								<div className="p-4 p-sm-7">
									...
									{/* <!-- Title --> */}
									<h1 className="mb-2 h3">Welcome Back, Foundation</h1>
									<p className="mb-0">New here?<a href="signup-foundation"> Create an account</a></p>
